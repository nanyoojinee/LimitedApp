...
export async function GET(request) {
    ...
    try {
        const paginatedResults = await new Promise((resolve, reject) => {
            const query = "SELECT * FROM doplan ORDER BY createdAt DESC LIMIT ? OFFSET ?";
        ...
        const totalCount = await new Promise((resolve, reject) => {
            const query = "SELECT COUNT(*) AS total FROM doplan";
...
export async function POST(request) {
    ...
    try {
        await new Promise((resolve, reject) => {
            const query = `INSERT INTO doplan (text, link) VALUES (?, ?)`;
            // JavaScript의 null 사용
...
export async function PUT(request) {
    ...
    try {
        await new Promise((resolve, reject) => {
            const query = "UPDATE doplan SET text = ?, link = ? WHERE id = ?";
...
export async function DELETE(request) {
    ...
    try {
        await new Promise((resolve, reject) => {
            const query = "DELETE FROM doplan WHERE id = ?";
